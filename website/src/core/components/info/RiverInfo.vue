<template>
  <div id="river-info" class="image-offset">
    ...
    <div v-if="riverInfo.administrative_territorials && riverInfo.administrative_territorials.length">
      <p>Административные территории:</p>
      <ul id="administrative-territorials-river">
        <li v-for="(territorialUnit, index) in riverInfo.administrative_territorials" :key="index">
          {{ territorialUnit }}
        </li>
      </ul>
    </div>
